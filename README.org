...
Repo.conflict_num            # number of conflicts in repo
Repo.ahead                   # number of commits ahead of remote
Repo.behind                  # number of commits behind remote
Repo.staged_num              # number of staged files
Repo.modified_num            # number of changed modified files
Repo.untracked_num           # number of untracked files
